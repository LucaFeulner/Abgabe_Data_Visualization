...
# Die Datei liegt auf meinemLaptop weil die  zu groß ist um sie  abzugeben,  die Zeilen habe ich aber drin gelassen,  damit Sie nachvollziehen können, was ich gemacht habe
...
# df1 = pd.read_csv("Abgabe/res/AbgabeDatenset.csv")
# df2 = pd.read_csv("Abgabe/res/airports.csv", sep=";")
# df4 = pd.read_csv("Abgabe/res/airlines.csv", sep=",")

# # Spalte umnennen  da  sonst zwei mal die selbe spalte existiert
# df4 =df4.rename(columns={"AIRLINE":"AIRLINE_NAME"})


# # Die drei Datensets  zun einem zusammenfügen
# df3 = pd.merge(df1, df2[['IATA_CODE', 'STATE', "AIRPORT"]], left_on='ORIGIN_AIRPORT', right_on='IATA_CODE', how='left')
